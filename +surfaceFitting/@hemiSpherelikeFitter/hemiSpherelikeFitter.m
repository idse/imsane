classdef hemiSpherelikeFitter < surfaceFitting.surfaceFitter
    ...
    methods
        ...
        function fitSurface(this, pointCloud)
            ...
            c1step = this.getChartResolution('cylinder');
            dz = c1step(1);
            dphi = dz/sqrt(max(rsq));
            stepSize = [dz dphi];
            this.setChartResolution('cylinder', stepSize);
           
            
            % generate cylinder1 embedding to inspect the fit and normally
            % evolve
            this.fittedPoints = this.generateEmbedding('cylinder').apply;
        end
        ...
        function normallyEvolve(this, shift, varargin)
            ...
            outCloud = surfaceDetection.PointCloud(xs(1:100:end,:));
    ...
    methods (Access = private)
        ...
        function parameterFit(this, pointCloud, fitOptions)
            ...
            for t = 1:length(zind)
                ...
                %rzeqt = (rz==zind(t));
                rzeqt = intersect(find(rz<zind(t)+50),find(rz>zind(t)-50));
            ...
            this.fittedParam.phimin = min(phimin(index));
            this.fittedParam.phimax = max(phimax(index));
            ...
            this.fittedParam.zmin = min(zind)+5;
            this.fittedParam.zmax = max(zind)-5;

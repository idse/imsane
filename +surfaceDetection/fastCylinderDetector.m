classdef fastCylinderDetector < surfaceDetection.surfaceDetector
    ...
    methods
        ...
        function this = fastCylinderDetector()
        ...
        function detectSurface(this, stack)
            ...
            ySize = size(edgeData, idxPerm(1));
            xSize = size(edgeData, idxPerm(2));
            zSize = size(edgeData, idxPerm(3));
